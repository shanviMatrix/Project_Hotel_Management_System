    ...
    try:
        with open("customers.txt", "r") as f:
            for line in f:
                ...
                if data[0].lower() == name.lower() and data[1] == id_proof:
                    return data[2]
        return None
    except:
        return None
...
class HotelManagementSystem:
        ...
        def process_booking():
            ...
            try:
                ...
                for line in rooms:
                    ...
                    if data[1] == room_type and data[2] == "Available" and not booked:
                        ...
                        with open("customers.txt", "a") as c:
            ...
            try:
                ...
                if found:
                    ...
                    messagebox.showinfo(
                        ...
                        f"Customer: {customer_data[0]}\n"
                        f"Room: {customer_data[2]}\n"
                        f"Total Paid: ₹{customer_data[5]}\n"
                        f"Check-out Time: {get_timestamp()}"
                    )
                    self.create_main_menu()
                else:
    ...
    def order_food(self):
        ...
        def place_order():
            orders = [(item, qty.get(), price) for item, (price, qty) in selections.items() 
                     if qty.get() > 0]
    ...
    def request_housekeeping(self):
        ...
        services = {
            "Room Cleaning": tk.BooleanVar(),
            "Bed Sheet Change": tk.BooleanVar(),
            "Towel Replacement": tk.BooleanVar(),
            "Bathroom Cleaning": tk.BooleanVar(),
            "Full Service": tk.BooleanVar()
        }
        ...
        for service, var in services.items():
            ...
            tk.Checkbutton(check_frame, text=service, variable=var, 
        ...
        def submit_request():
            selected = [s for s, v in services.items() if v.get()]
            ...
            timestamp = get_timestamp()
            with open("housekeeping.txt", "a") as f:
                for service in selected:
                    f.write(f"{customer['name']},{customer['id']},{customer['room']},"
                           f"{service},{pref_time},{special_req},{timestamp},Pending\n")
    ...
    def submit_grievance(self):
        ...
        def submit():
            ...
            timestamp = get_timestamp()
            with open("grievances.txt", "a") as f:
                f.write(f"{customer['name']},{customer['id']},{customer['room']},"
    ...
    def submit_feedback(self):
        ...
        for category in categories:
            ...
            for j in range(1, 6):
                tk.Radiobutton(star_frame, text=f"{'⭐' * j}", variable=rating_var,
